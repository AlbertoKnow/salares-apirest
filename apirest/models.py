...
class Equipments(models.Model):
    ...
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
    url_iteractivo = models.CharField(max_length=10, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)
    video = models.CharField(max_length=10, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)
    parent_id = models.CharField(max_length=10, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)
...
class Files(models.Model):
    ...
    level_id = models.ForeignKey('Levels', on_delete=models.CASCADE, blank=True, null=True)
    ...
    share_files = models.ManyToManyField('self', blank=True, null=True)
    deleted_at = models.DateTimeField(blank=True, null=True)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class SharedFiles(models.Model):
    file_origin_id = models.ForeignKey('Files', related_name='File_origin_id', on_delete=models.CASCADE)
    file_share_id = models.ForeignKey('Files', models.DO_NOTHING, related_name='File_share_id')
...
class Interlug(models.Model):
    ...
    # !ver el porque del related_name
    id_shape_to = models.ForeignKey('Shapes', models.DO_NOTHING, db_column='id_shape_to', related_name='to')
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
